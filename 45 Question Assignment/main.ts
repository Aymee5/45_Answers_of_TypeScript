...
//Question 13:
let Transportation :string[] = ['Car','Motorcycle','Train','Bus']
for(let i = 0; i < Transportation.length; i++) {
    console.log('I would like to own a ' + Transportation[i])
}
//Question 14:
let Guest_list :string[] = ['Ayeza','Sherish','Rimsha']

for(let i = 0; i < Guest_list.length; i++) {
    console.log('Dear' + Guest_list[i] + ', \n\n It is our pleasure to invite you in our party.\n\nThank you')
}
//Question 15:
let absent_guest :String = "Sherish";

let new_guest :string = "Reeja";
...
let places :string[] = ['London','Italy','Germany','Egypt','USA']
...
let items :string[] = ["karachi","Pakistan","English"]
...
// Question 22:
//Creating Array
let Books :string[] = ["English", "Urdu","Math"]
...
console.log("Equlity test with strings: ", ("Apple" as string) != "Orange"); //True
...
console.log("Inequality test with numbers", (20 as number) != 19 ); //True
...
// Question 29:
let favorate_fruits :string[] = ["apples","banana","cherries"];
